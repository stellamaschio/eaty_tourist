...
class ListFoods {
  ...
  static const List<Food> foodList = [
    Food(name: 'APPLE', calories: 65, index: 1, icon: MdiIcons.foodApple,
    ...
    Food(name: 'TOAST', calories: 150, index: 2, icon: MdiIcons.toaster,
    ...
    Food(name: 'ICECREAM', calories: 247, index: 3, icon: MdiIcons.iceCream,
    ...
    Food(name: 'PASTA', calories: 360, index: 4, icon: MdiIcons.pasta,
    ...
    Food(name: 'CAKE', calories: 450, index: 5, icon: MdiIcons.cupcake,
    ...
    Food(name: 'STEAK', calories: 630, index: 6, icon: MdiIcons.foodSteak,
    ...
    Food(name: 'PIZZA', calories: 700, index: 7, icon: MdiIcons.pizza,
